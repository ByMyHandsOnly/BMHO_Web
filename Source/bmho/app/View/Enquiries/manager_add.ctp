...
<div class="enquiries form">
    ...
    <fieldset>
        <legend><?php echo __('Enquiry'); ?> <small><?php echo __('Manager Add enquiry'); ?></small></legend>
		<?php
		...
		?>
		<?php echo $this->Form->submit(__('Add'), array('class' => 'btn btn-primary')); ?>    </fieldset>
