<div class="row-fluid">
    <div class="span12">
        <h3><?php echo __('All Enquiries'); ?></h3>
        <hr />
		<!--        <div class="btn-group">
		<?php echo $this->Html->link(__('Add New Enquiry'), array('action' => 'add'), array('class' => 'btn btn-primary', 'icon' => 'plus white')); ?>        
				</div>
				<br />-->
			...
			<table class="table table-bordered table-hover table-striped">
				<thead>
					<tr>
						...
						<th style="width: 150px"><?php echo $this->Paginator->sort('user_id', __('User Id')); ?></th>
						<th><?php echo $this->Paginator->sort('subject', __('Subject')); ?></th>
