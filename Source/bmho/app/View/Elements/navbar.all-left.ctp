...
<div class="hero-unit" style="position:absolute; min-height: 0px;line-height: 10px;background-image: url(<?php echo Configure::read('MyApp.banner'); ?>); background-repeat: no-repeat; background-position: left top">
   <div class="" style="position:relative; valign:top;">
      <a href="#" class="btn btn-primary btn-small"><i class="icon-white icon-shopping-cart"></i> Basic $1/month </a><br>
      <a href="#" class="btn btn-warning btn-small"><i class="icon-white icon-plus"></i> Basic Plus $5/month</a><br>
